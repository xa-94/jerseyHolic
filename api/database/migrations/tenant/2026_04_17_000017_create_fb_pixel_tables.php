...
return new class extends Migration
{
    ...
    {
        // Facebook Pixel 配置
        Schema::create('fb_pixel_configs', function (Blueprint $table) {
            $table->id();
        ...
        // Facebook 事件名称配置
        Schema::create('fb_event_names', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fb_event_names');
        Schema::dropIfExists('fb_pixel_configs');
    }
};
