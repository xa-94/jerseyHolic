...
return new class extends Migration
{
    ...
    {
        // 物流供应商
        Schema::create('jh_shipping_providers', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('jh_shipping_provider_mappings', function (Blueprint $table) {
            $table->id();
        ...
        // 运费区域
        Schema::create('jh_shipping_zones', function (Blueprint $table) {
            $table->id();
        ...
        // 运费规则
        Schema::create('jh_shipping_rules', function (Blueprint $table) {
            $table->id();
        ...
        // 发货单
        Schema::create('jh_shipments', function (Blueprint $table) {
            $table->id();
        ...
        // 物流轨迹
        Schema::create('jh_shipment_tracks', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('jh_shipment_tracks');
        Schema::dropIfExists('jh_shipments');
        Schema::dropIfExists('jh_shipping_rules');
        Schema::dropIfExists('jh_shipping_zones');
        Schema::dropIfExists('jh_shipping_provider_mappings');
        Schema::dropIfExists('jh_shipping_providers');
    }
};
