...
return new class extends Migration
{
    ...
    {
        // 安全商品名称库
        Schema::create('jh_safe_products', function (Blueprint $table) {
            $table->id();
        ...
        // 商品与安全名称精确映射关系
        Schema::create('jh_product_safe_mapping', function (Blueprint $table) {
            $table->id();
        ...
        // SKU 前缀配置
        Schema::create('jh_sku_prefix_configs', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('jh_sku_prefix_configs');
        Schema::dropIfExists('jh_product_safe_mapping');
        Schema::dropIfExists('jh_safe_products');
    }
};
