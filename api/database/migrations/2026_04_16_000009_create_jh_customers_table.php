...
return new class extends Migration
{
    ...
    {
        Schema::create('jh_customer_groups', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('jh_customers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('jh_customers');
        Schema::dropIfExists('jh_customer_groups');
    }
};
