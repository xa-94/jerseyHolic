...
return new class extends Migration
{
    ...
    {
        // 商品 SKU/变体
        Schema::create('jh_product_skus', function (Blueprint $table) {
            $table->id();
        ...
        // 商品图片
        Schema::create('jh_product_images', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('product_id')->comment('商品ID');
        ...
        // 商品属性
        Schema::create('jh_product_attributes', function (Blueprint $table) {
            $table->id();
        ...
        // 商品属性值
        Schema::create('jh_product_attribute_values', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('product_id')->comment('商品ID');
        ...
        // 商品-分类关联（多对多）
        Schema::create('jh_product_categories', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('product_id')->comment('商品ID');
    ...
    {
        Schema::dropIfExists('jh_product_categories');
        Schema::dropIfExists('jh_product_attribute_values');
        Schema::dropIfExists('jh_product_attributes');
        Schema::dropIfExists('jh_product_images');
        Schema::dropIfExists('jh_product_skus');
    }
};
